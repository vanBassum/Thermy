...
DisplayManager::DisplayManager(AppProvider &app)
    : app_(app)
    , sensorManager(app.getSensorManager())
    , homePage(app.getStrux().getNetworkManager(), app.getSensorManager(),
               app.getStrux().getSettingsManager())
    , wifiPage(app.getStrux().getSettingsManager(), app.getStrux().getNetworkManager())
    , sensorPage(app.getStrux().getSettingsManager(), app.getSensorManager())
    , graphPage(app.getStrux().getSettingsManager())
    , systemPage(app.getStrux().getSettingsManager())
{
...
void DisplayManager::Init()
{
    ...
    app_.getStrux().getSettingsManager().Register({ &graphMin_, &graphMax_ });
